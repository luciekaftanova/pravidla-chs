...
. Každá cesta nebo boulder musí být navrženy tak, aby se předešlo nebezpečí zranění soutěžícího při pádu, popřípadě zranění nebo omezení jakéhokoliv jiného soutěžícího nebo třetí osoby.
. Hlavní rozhodčí a Hlavní stavěč musí zkontrolovat každou cestu nebo boulder před zahájením každého soutěžního kola, aby se zajistilo zachování bezpečnostních norem.
...
. Hlavní rozhodčí musí ověřit, že je na místě vhodně kvalifikovaný zdravotnický personál, aby bylo možné zajistit rychlou pomoc v případě jakékoli nehody nebo úrazu jakéhokoliv <<#clenove-tymu,člena týmu>>. Tento zdravotnický personál soutěže musí být přítomen od plánovaného otevření izolace nebo rozcvičovací zóny do konce pokusu posledního soutěžícího.
...
. Hlavní stavěč musí ověřit, že je v průběhu každého kola k dispozici zkušený tým údržby, aby bylo možné efektivně a bezpečně provést jakoukoliv údržbu nebo opravu nařízenou Hlavním rozhodčím. Bezpečnostní opatření musí být striktně dodržována.
...
+
Získal-li soutěžící nespravedlivé zvýhodnění, pak Hlavní rozhodčí může ukončit pokus, nebo povolit soutěžicímu pokračovat. V tomto případě výsledek pokusu bude zpětně vyhodnocen, a nesmí být povolen žádný další pokus v cestě, dokud není Technický incident následně potvrzen.
...
... Je-li soutěžící v povolené poloze v důsledku technického incidentu oznámeného Hlavním rozhodčím, může se buď rozhodnout, zda bude pokračovat v lezení nebo ohlásí technický incident. Rozhodne-li se soutěžící lézt dál, znamená to konec technického incidentu a v budoucnu nebude brán ohled na žádné protesty s tímto incidentem spojené.
...
. Není-li Hlavním rozhodčím určeno jinak, musí se všichni soutěžící zúčastnit zahajovacího ceremoniálu, pokud se koná. V případě, že tak neučiní, budou soutěžící podrobeni disciplinárnímu postihu ve shodě s částí <<#disciplinarni-rizeni>>.
