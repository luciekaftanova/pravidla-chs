...
. Disciplinární komise ČHS je orgánem ČHS, který se zabývá prosazováním pravidel v lezeckých soutěžích, které zahrnují lezení na obtížnost, lezení na rychlost a boulder & obtížnost.
